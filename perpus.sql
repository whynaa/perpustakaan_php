...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Okt 2021 pada 02.55
...
(1, 'Laskar Pelangi', 'Andrea Hirata', 'Laskar Pelangi ini bercerita mengenai kehidupan anak-anak di desa Gantong, Pulau Belitung pada masa sekolahnya.', '8906laskar_pelangi.jpeg'),
(3, 'Sang Pemimpi', 'Andrea Hirata', 'Sang Pemimpi menceritakan mengenai Ikal dan saudara sepupunya, Arai, serta sahabatnya, Jimbron, yang mencari identitas diri pada usia 17 tahun.', '1348Sang_Pemimpi.jpg'),
(4, 'Edensor', 'Andrea Hirata', 'Edensor menceritakan petuangan Ikal dan Arai di eropa', '6046Edensor.jpg');
...
(1, 1, '2021-10-06', '2021-10-13'),
(2, 1, '2021-10-01', '2021-10-02'),
(3, 1, '2021-10-06', '2021-10-13');
...
(1, 'Whyna', '2021-09-28', 'P', 'Malang', 'whyna', 'd41d8cd98f00b204e9800998ecf8427e', 5),
(2, 'Agustin', '2021-09-28', 'P', 'Surabayaa', 'Agustin', 'd41d8cd98f00b204e9800998ecf8427e', 9);
...
ALTER TABLE `detail_peminjaman_buku`
  ...
  ADD KEY `peminjaman_buku` (`id_peminjaman_buku`),
...
--
ALTER TABLE `detail_peminjaman_buku`
  ADD CONSTRAINT `detail_peminjaman_buku_ibfk_1` FOREIGN KEY (`id_buku`) REFERENCES `buku` (`id_buku`) ON UPDATE CASCADE,
  ADD CONSTRAINT `detail_peminjaman_buku_ibfk_2` FOREIGN KEY (`id_peminjaman_buku`) REFERENCES `peminjaman_buku` (`id_peminjaman_buku`) ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `peminjaman_buku`
--
ALTER TABLE `peminjaman_buku`
  ADD CONSTRAINT `peminjaman_buku_ibfk_1` FOREIGN KEY (`id_siswa`) REFERENCES `siswa` (`id_siswa`) ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `pengembalian_buku`
--
ALTER TABLE `pengembalian_buku`
  ADD CONSTRAINT `pengembalian_buku_ibfk_1` FOREIGN KEY (`id_peminjaman_buku`) REFERENCES `peminjaman_buku` (`id_peminjaman_buku`) ON UPDATE CASCADE;
